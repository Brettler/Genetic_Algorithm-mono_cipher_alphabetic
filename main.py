...
def generate_initial_population(size):
    ...
    population = []
    # Generate a specified number of random solutions.
    for _ in range(size):
        # Create a list of uppercase alphabet letters.
        alphabet = list("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
        # Randomly shuffle the alphabet list.
        random.shuffle(alphabet)
        # Create a list of tuples where each tuple contains the original letter and its corresponding shuffled letter.
        solution = [(original, shuffled) for original, shuffled in zip("ABCDEFGHIJKLMNOPQRSTUVWXYZ", alphabet)]
        # Add the generated solution to the population list.
        population.append(solution)
    # Return the complete population list
    return population
